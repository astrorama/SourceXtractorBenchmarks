...
data_file_path = '../../DEEPFIELD/FIELD%s/Realistic_Morphologies/realm_%s_vis.fits' % (act_field, act_field)
rms_file_path  = '../../DEEPFIELD/FIELD%s/Realistic_Morphologies/realm_%s_vis.rms.fits' % (act_field, act_field)
