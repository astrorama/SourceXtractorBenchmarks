...
X_bulge_ratio = DependentParameter(lambda r: np.log((r-0.15)/(0.85-r)), bulge_ratio)
add_prior(X_bulge_ratio, 0.35, 1.6)
...
X_bulge_fract =  DependentParameter(lambda bf: np.log((bf+0.000001)/(1.01-bf)), bulge_fract)
add_prior(X_bulge_fract, -2.8, 2.1)
